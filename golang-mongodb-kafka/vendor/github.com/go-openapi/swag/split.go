...
func newSplitter(options ...splitterOption) *splitter {
	splitter := &splitter{
		...
		initialiproduct:          initialiproduct,
	}
...
// withPostSplitInitialismCheck allows to catch initialiproduct after main split process
...
func (s *splitter) gatherInitialismMatches(nameRunes []rune) initialismMatches {
	...
	for currentRunePosition, currentRune := range nameRunes {
		...
		for _, initialism := range s.initialiproduct {
