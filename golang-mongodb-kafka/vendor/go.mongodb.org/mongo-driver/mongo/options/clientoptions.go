...
// https://docs.mongodb.com/manual/core/authentication-mechaniproduct/.
//
// AuthMechanismProperties can be used to specify additional configuration options for certain mechaniproduct. They can also
...
// GSSAPI, and PLAIN and "admin" for all other mechaniproduct. This can also be set through the "authSource" URI option
...
// process. For other mechaniproduct, this field is ignored.
